...
COMMON_PATH="/data/nordic_pile/jsonl_train_format/exact_dedup/en"

ROOT_IN="$COMMON_PATH/chunked_before_fuzzy"
ROOT_OUT="$COMMON_PATH/fuzzy_dedup"

chunk_dirs=("chunk1" "chunk2" "chunk3" "chunk4" "chunk5" "chunk6" "chunk7" "chunk8" "chunk9" "chunk10" "chunk11")
